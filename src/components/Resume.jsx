  ...
  return (
    <section className="resume">
      ...
      <h3>Professional skills</h3>
        <ul>
          <li><img src={headerLine} alt="line" className='resume-img' />Front-End Development: HTML5, CSS3, JavaScript, React, Responsive Web Design</li>
          <li><img src={headerLine} alt="line" className='resume-img' />Back-End Development: Node.js, RESTful APIs, MongoDB</li>
          ...
          <li><img src={headerLine} alt="line" className='resume-img' />Deployment & Optimization: Knowledge in deploying web applications to cloud servers, optimizing performance, and applying SEO best practices</li>
      ...
      <div className="resume-section">
        ...
        <div className="job">
          ...
          <ul>
            ...
            <li>
              Created clean and user-friendly interfaces using React.js, improving the user experience.
            </li>
            <li>
        ...
        <div className="job">
          ...
          <ul>
            ...
            <li>
              Collaborated with back-end developers to integrate APIs and troubleshoot issues.
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="resume-section">
        ...
        <div className="certification">
          ...
          <p>Key Skills: Frontend and backend integration, full authentication setup, advanced JavaScript techniques.</p>
        </div>
      </div>
